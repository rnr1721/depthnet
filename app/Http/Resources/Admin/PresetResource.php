...
class PresetResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            'id' => $this->id,
            'target_preset_id'         => $this->target_preset_id,
            'target_plugins_whitelist' => $this->target_plugins_whitelist,
            ...
            'pre_pass_enabled'           => $this->pre_pass_enabled,
            'pre_pass_instruction'       => $this->pre_pass_instruction,
