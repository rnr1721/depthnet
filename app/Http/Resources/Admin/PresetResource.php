...
class PresetResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'rag_relative_dates'         => $this->rag_relative_dates,
            'rag_journal_limit'          => $this->rag_journal_limit,
            'rag_skills_limit'           => $this->rag_skills_limit,
            'rag_content_limit'          => $this->rag_content_limit,
            'rag_journal_context_window' => $this->rag_journal_context_window,
            ...
            'rhasspy_enabled'          => $this->rhasspy_enabled,
            'rhasspy_url'              => $this->rhasspy_url,
            'rhasspy_tts_voice'        => $this->rhasspy_tts_voice,
            'rhasspy_incoming_enabled' => $this->rhasspy_incoming_enabled,
            'rhasspy_incoming_token'   => $this->rhasspy_incoming_token,
