        ...
        $this->languageConfig = [
            'en' => [
                ...
                'stop_words' => ['the', 'a', 'an', 'and', 'or', 'but', 'in', 'on', 'at', 'to', 'for', 'of', 'with',
                                 ...
                                 'these', 'those', 'here', 'there', 'where', 'when', 'why', 'how', 'what', 'which',
                                 'who', 'if', 'then', 'than', 'as', 'so', 'very', 'more', 'most', 'some', 'any', 'all'],
                'endings'    => ['tion', 'ing', 'ment', 'ness', 'ful', 'ous', 'ive', 'ed', 'ly', 's', 'er', 'est',
                                 'able', 'ible', 'ence', 'ance', 'ship', 'hood', 'less', 'ize', 'ise', 'ate', 'ify', 'en'],
                'detection_patterns' => [
                    'charset'     => 'latin',
                    'threshold'   => 0.7,
                    'sample_words' => ['which', 'their', 'would', 'there', 'could', 'other', 'through', 'where', 'every', 'should']
                ],
            ],
            'ru' => [
                'name'       => 'Russian',
                ...
                'stop_words' => ['и', 'в', 'на', 'что', 'как', 'это', 'для', 'с', 'по', 'от', 'до', 'из',
                                 ...
                                 'все', 'уже', 'где', 'когда', 'почему', 'через', 'после', 'перед', 'между', 'над',
                                 'при', 'без', 'про', 'чем', 'тем', 'если', 'чтобы', 'пока', 'тогда', 'только',
                                 'также', 'даже', 'может', 'можно', 'нужно', 'очень', 'более', 'менее', 'самый'],
                'endings'    => ['ение', 'ость', 'ова', 'ева', 'ать', 'ить', 'еть', 'ов', 'ев', 'ий', 'ая', 'ое', 'ые',
                                 'енн', 'ощ', 'ющ', 'ем', 'ах', 'ами', 'ной', 'ным', 'ных', 'тся', 'ться', 'ся', 'ший',
                                 'щий', 'вший', 'ный', 'тый', 'мый', 'лся', 'лось', 'лись', 'ала', 'ало', 'али'],
                'detection_patterns' => [
                    'charset'     => 'cyrillic',
                    'threshold'   => 0.3,
                    'sample_words' => ['который', 'является', 'может', 'очень', 'сейчас', 'только', 'через', 'после', 'перед', 'между']
                ],
            ],
            'de' => [
                'name'       => 'German',
                'code'       => 'de',
                'stop_words' => ['der', 'die', 'das', 'und', 'oder', 'aber', 'in', 'auf', 'an', 'zu', 'für', 'von',
                                 'mit', 'bei', 'ist', 'sind', 'war', 'waren', 'sein', 'haben', 'hat', 'hatte', 'werden',
                                 'wird', 'wurde', 'kann', 'können', 'muss', 'müssen', 'soll', 'will', 'wollen', 'dieser',
                                 'diese', 'dieses', 'hier', 'dort', 'wo', 'wann', 'warum', 'wie', 'was', 'welcher', 'wer',
                                 'ich', 'du', 'er', 'sie', 'es', 'wir', 'ihr', 'mich', 'dich', 'ihn', 'uns', 'nicht', 'kein'],
                'endings'    => ['ung', 'heit', 'keit', 'schaft', 'tion', 'ieren', 'ierte', 'iert', 'lich', 'ig', 'isch',
                                 'bar', 'sam', 'haft', 'los', 'er', 'en', 'es', 'em', 'e', 'st', 'ste', 'sten', 'end', 'nd'],
                'detection_patterns' => [
                    'charset'     => 'latin',
                    'threshold'   => 0.7,
                    'sample_words' => ['welcher', 'welche', 'welches', 'dieser', 'diese', 'dieses', 'jeder', 'jede',
                                       'jedes', 'können', 'müssen', 'sollen', 'wollen', 'werden', 'haben']
                ],
            ],
            'fr' => [
                'name'       => 'French',
                'code'       => 'fr',
                'stop_words' => ['le', 'la', 'les', 'un', 'une', 'des', 'et', 'ou', 'mais', 'dans', 'sur', 'à', 'au',
                                 'de', 'du', 'pour', 'avec', 'par', 'est', 'sont', 'était', 'être', 'avoir', 'a', 'ont',
                                 'peut', 'peuvent', 'doit', 'doivent', 'veut', 'veulent', 'ce', 'cette', 'ces', 'cela',
                                 'ici', 'là', 'où', 'quand', 'pourquoi', 'comment', 'que', 'quoi', 'quel', 'quelle',
                                 'qui', 'dont', 'si', 'alors', 'donc', 'comme', 'très', 'plus', 'moins', 'chaque', 'tout',
                                 'tous', 'toute', 'toutes', 'autre', 'autres', 'même', 'mêmes', 'seulement', 'aussi',
                                 'encore', 'déjà', 'maintenant', 'avant', 'après', 'je', 'tu', 'il', 'elle', 'nous', 'vous',
                                 'ils', 'elles', 'me', 'te', 'se', 'lui', 'leur', 'mon', 'ton', 'son', 'notre', 'votre',
                                 'ne', 'pas', 'ni', 'car', 'y', 'en'],
                'endings'    => ['tion', 'sion', 'ment', 'ance', 'ence', 'esse', 'ise', 'ure', 'ade', 'age', 'able',
                                 'ible', 'eux', 'euse', 'ique', 'iste', 'isme', 'ier', 'ière', 'er', 'ir', 're', 'é',
                                 'ée', 'és', 'ées', 'ant', 'ent', 'ait', 'aient', 'ons', 'ez', 'ont', 'e', 'es', 'ent'],
                'detection_patterns' => [
                    'charset'     => 'latin',
                    'threshold'   => 0.7,
                    'sample_words' => ['lequel', 'laquelle', 'lesquels', 'lesquelles', 'celui', 'celle', 'ceux',
                                       'celles', 'pouvoir', 'vouloir', 'devoir', 'savoir', 'faire', 'aller', 'venir']
                ],
            ],
            'es' => [
                'name'       => 'Spanish',
                'code'       => 'es',
                'stop_words' => ['el', 'la', 'los', 'las', 'un', 'una', 'unos', 'unas', 'y', 'o', 'pero', 'en', 'sobre',
                                 'a', 'al', 'del', 'para', 'con', 'por', 'es', 'son', 'era', 'eran', 'ser', 'estar',
                                 'tener', 'ha', 'han', 'había', 'puede', 'pueden', 'podía', 'debe', 'deben', 'quiere',
                                 'quieren', 'quería', 'este', 'esta', 'estos', 'estas', 'ese', 'esa', 'esos', 'esas',
                                 'aquel', 'aquella', 'aquellos', 'aquellas', 'esto', 'eso', 'aquello', 'aquí', 'allí',
                                 'allá', 'dónde', 'cuándo', 'cómo', 'qué', 'cuál', 'cuáles', 'quién', 'quiénes', 'cuyo',
                                 'cuya', 'cuyos', 'cuyas', 'si', 'entonces', 'como', 'tan', 'muy', 'más', 'menos', 'algún',
                                 'alguna', 'algunos', 'algunas', 'cada', 'todo', 'todos', 'toda', 'todas', 'otro', 'otra',
                                 'otros', 'otras', 'mismo', 'misma', 'mismos', 'mismas', 'tal', 'tales', 'sólo', 'también',
                                 'aún', 'todavía', 'ya', 'ahora', 'antes', 'después', 'durante', 'entre', 'bajo', 'hacia',
                                 'hasta', 'desde', 'sin', 'yo', 'tú', 'él', 'ella', 'usted', 'nosotros', 'vosotros',
                                 'ellos', 'ellas', 'ustedes', 'me', 'te', 'se', 'le', 'les', 'nos', 'os', 'mi', 'tu', 'su',
                                 'nuestro', 'vuestro', 'no', 'ni', 'que'],
                'endings'    => ['ción', 'sión', 'miento', 'ancia', 'encia', 'eza', 'idad', 'tad', 'tud', 'ble', 'able',
                                 'ible', 'oso', 'osa', 'ivo', 'iva', 'ico', 'ica', 'ista', 'ismo', 'dor', 'dora', 'ar',
                                 'er', 'ir', 'ado', 'ada', 'ido', 'ida', 'ando', 'iendo', 'aba', 'ía', 'é', 'í', 'ó',
                                 'aste', 'iste', 'aron', 'ieron', 's', 'es', 'as', 'os', 'as', 'es', 'en', 'an', 'amos',
                                 'emos', 'imos'],
                'detection_patterns' => [
                    'charset'     => 'latin',
                    'threshold'   => 0.7,
                    'sample_words' => ['entonces', 'porque', 'cuando', 'donde', 'también', 'todavía', 'mientras',
                                       'después', 'nuestro', 'vuestro', 'aquellos', 'nosotros', 'vosotros', 'ustedes']
                ],
            ],
        ];
    }
